...
/*
* curves a raycast, good for grenades, or bulletdrop using raycast
* Carl Eriksson
* 2021-04-02
*/

public class Trajectory : MonoBehaviour {
    [Range(0.1f, 0.6f)] [SerializeField] private float intervals = 0.1f;
    [SerializeField] private float incline = 12f;
    [SerializeField] private float reach = 10f;
    [Range(0.1f, 0.8f)] [SerializeField] private float rayStopDist = 0.1f;
